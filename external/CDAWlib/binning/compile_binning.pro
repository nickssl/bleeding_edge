...
;$Header: /usr/local/share/cvsroot/cdaweb/IDL/binning/compile_binning.pro,v 1.5 2019/08/08 22:10:28 ryurow Exp $
;$Locker:  $
;$Revision: 29691 $
;
...
.run cmb_add_var2datastructure.pro
.run cmb_autobad.pro
...
.run cmb_cdf_add_global_attribute.pro
...
.run cmb_check_delta.pro
.run cmb_collapse.pro
.run cmb_dat.pro
.run cmb_dat_storedata.pro
.run cmb_data_in_range.pro
...
.run cmb_add_dependencies_of_binned_data.pro
