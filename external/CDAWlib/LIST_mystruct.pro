...
;
; Establish error handler
;  RCJ 12Feb2018  Commented out the error catch. Shouldn't be an error
;                 if label is not found, but should issue a warning to developers.

;print, "***************************"
;print, "JENSUN -- label_search"
;print, "sz is: ", sz
;print, "i is: ", i
;print, "k is: ", k
;print, "***************************"
...
;print, "JENSUN ------------- CASE 0 "
;print, "sz is : ",sz
;print, "len, lent, and length are : ", len, lent, length
;print, ""
   ...
   if(strcmp(a.(i).var_notes,'ListImage',9) eq 0) then begin
	 ...
	 ;
	    ...
	    lab=a.(z[0]).labl_ptr_1
                ...
                ;print,'Depend_1: ', depend1, ' not found (ListImage section of LIST_mystruct).'
...
for i=0L, slen-1 do begin
   ...
   ; Check for a forbidden control character (IE. new line, form feed).  Conveert these to spaces.
   ; Ron Yurow (May 10, 2022)
...
for k=0L, length-1 do begin
   ...
   ;  endif else begin   
   ;   if (size(dat[k],/type) eq 14) then begin ; if long64
   ;        ;CDF_EPOCH,dat[k], yr, mo, dy, hr, mn, sc, milli, micro, /break,/tointeger 
   ;        CDF_EPOCH,dat[k], yr, mo, dy, hr, mn, sc, milli, /break,/tointeger
   ;	   micro=(dat[k]-floor(dat[k],/l64))*1.e3 
   ;	 endif else begin
   ;       CDF_EPOCH,dat[k], yr, mo, dy, hr, mn, sc, milli, /break
   ;     endelse
...
for mega_loop=1, mega.num do begin
   ...
   IF  binning_flag && ~allowed_list_empty THEN BEGIN
       ; Bad bug.  Loop should itterate to end of depened_lst_ptr array.
       ; Ron Yurow (Nov 19, 2020)
...
;      endif
   ...
   for i=0,ns_tags-1 do begin
	 ...
	 ;print,'****  NOT changed fillval : ',c.(i).fillval
	 ;help,nvar
