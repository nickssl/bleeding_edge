...
;
;$Author: tkovalic $
;$Date: 2021/09/24 20:26:31 $
;$Header: /home/cdaweb/dev/control/RCS/read_mynetcdf.pro,v 1.22 2021/09/24 20:26:31 tkovalic Exp tkovalic $
;$Locker: tkovalic $
;$Revision: 1.22 $
;
...
;      findex = tagindex('FUNCTION', vartags) ; find the FUNCTION index number
      ...
      if (findex[0] ne -1) then begin ;found a virtual value w/ a function definition
         ...
         'comp_icon_epoch': begin ;for computing THEMIS epoch
