...
;
;PURPOSE:
;   NOTE: This routine is obsolete since all data is now publc
...
pro elf_init_private, reset=reset, local_data_dir=local_data_dir, remote_data_dir=remote_data_dir,$
